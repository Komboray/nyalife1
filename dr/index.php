...
<body>
    ...
    <div class="main">
        ...
        <div class="cardBox">
            ...
            <div href="n-handle-patient.php" class="card" style = "background-color:red; text-decoration: none" >
                <a href="n-handle-patient.php" style = "text-decoration: none">
                    <div class="numbers" style = "color:white"><?php echo "{$numPatients}" ?></div>
                    <div class="cardName" style = "color:white">Patient Profiles</div>
                </a>

                <a href="n-handle-patient.php" class="iconBx">
